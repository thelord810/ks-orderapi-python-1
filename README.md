...
```sh
pip install git+https://github.com/thelord810/ks-orderapi-python-1.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/thelord810/ks-orderapi-python-1.git`)
